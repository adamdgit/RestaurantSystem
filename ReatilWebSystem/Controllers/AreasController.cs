...
namespace BitByByte.Controllers
{
    ...
    public class AreasController : Controller
    {
        ...
        public AreasController(RestaurantDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Area != null ? 
                          ...
                          Problem("Entity set 'RestaurantDbContext.Area'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantDbContext.Area'  is null.");
            }
            var area = await _context.Area.FindAsync(id);
            if (area != null)
            {
